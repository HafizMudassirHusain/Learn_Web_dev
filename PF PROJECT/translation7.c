#include<stdio.h>
   ...
   {
    printf("PARA no 7\n");
    printf("SURAH AL-MAIDAH\n");
 char para[35][650]={":And when they hear that which was revealed to the Messenger (i.e. the Prophet Muhammad), you therefore see their eyes overflowing with tears because they have recognised the truth. They say, 'O our Lord, we have accepted faith; record us therefore amongst the witnesses of truth(83).\n",
...
":On the Day when Allah will gather (all) the Messengers, then will say, 'What answer was given to you (by your followers)?' They will submit (while saying out of humbleness), 'We do not have any knowledge; indeed, it is only You (Who is) the Great Knower of all the unseen.(109)'\n",
":When Allah will say, 'O 'Eisa; the son of Maryam, remember My Favour upon you and upon your mother; when I helped you through the Holy Spirit (Jibra'eel), you would henceforth speak to people from the cradle and (also when) having reached a mature age. And when I taught you the Book, and wisdom, and the Tawrah and the Injeel, and when you would mould a birdlike figure from clay by My command and would breathe into it. It would therefore fly by My command, and you would cure the one who was born blind and cure the leper by My command, and when you would raise the dead (back to life) by My command, and when I restrained the Children of Israel from (assassinating) you; when you came to them with clear proofs. So, the disbelievers among them said that 'This is nothing but clear magic.(110\n",
...
":'I have not told them except only what You commanded me; that “Worship Allah Who is my Lord and also your Lord.” I was aware of them for as long as I was amongst them, when You then raised me, only You watched over them, and everything is present before You(117).\n",
":'If you punish them; so, they are Your bondsmen, and if you forgive them; so, only You are indeed the Overpowering, the Wise(118).\n",
":Allah said, 'This (i.e. Qiyaamah) is a Day on which the truthful will benefit from their truthfulness; for them are Gardens beneath which rivers flow, in which they will abide forever and ever. Allah is pleased with them and they are pleased with Allah; this is the great success(119).\n",
"7:last verse(120):Only to Allah belongs the kingdom of the heavens and the earth, and whatever is in them, and He has the power to do everything(120).\n"};

printf("7: SURAH AL AN'AAM\n TOTAL ROKU:(20)\nTOTAL WORDS:(3442)\nTOTAL LETTERS(12559)\n TOTAL AAYAAT(165)");

Printf("\tAllah's Name to commence with, the Most Gracious, the Most Merciful.");

char surah[121][650]={":All praise is due to Allah Who has created the heavens and the earth, and has created darknesses and light; despite this, the disbelievers (still) ascribe equals to their Lord(01).\n",
":It is He Who has created you from clay, and then decreed a term for you (to live). And a fixed promise is with Him (i.e. when you will be raised again), yet you people doubt(02).\n",
":And He is the very Allah of the heavens and the earth, He knows all; what you hide and what you disclose is known to Him, and He knows your doings(03).\n",
":And does not come to them at all any sign from amongst the signs of their Lord, but they turn their faces away from it(04).\n",
":So, they indeed belied the truth (i.e. verses of the Qur'aan, or the Prophet Muhammad and his miracles) when it came to them; so, they are now to be informed of that which they used to mock(05).\n",
":Did they not see how many nations We have destroyed before them, whom We had established more firmly in the earth, which We did not give to you, and We sent upon them abundant rain, and made the rivers flow beneath them? So, We destroyed them because of their sins, and created another nation after them(06).\n",
":And had We revealed to you (O Beloved) something written on paper, that they could feel it with their hands, even then the disbelievers would have said that 'This is nothing but clear magic(07).\n"
":And they (the disbelievers) said, 'Why has not an angel been sent down to him (whom we could see)?' And had We sent down an angel, the matter would have therefore been concluded (i.e. the disbelievers would have been destroyed), they would not have then been given respite(08).\n",
":And had We appointed an angel as a Prophet, We would still have made him a man and would have kept them in the same suspicion as they find themselves now(09).\n",
":And certainly, O Beloved, the Messengers before you have also been mocked; so, those who laughed at them were themselves ruined by their own mockery(10).\n",
":You declare (O Beloved), 'Travel the land, see then what was the outcome of those who belie(11).\n",
":Say you (O Beloved), 'To Whom belongs whatever is in the heavens and the earth?' Say you, 'To Allah.' He has decreed mercy on the responsibility of His Generosity; undoubtedly, He will definitely gather you together on the Day of Resurrection, in which there is no doubt. Those who put their own souls in loss do not believe(12).\n",
":And only to Him belongs whatever dwells in the night and in the day, and only He is the All- Hearing, the All-Knowing(13).\n",
